...
const SvgMaqueta = (props) => {
  const { areaColors = {}, ...svgProps } = props;

  const getFillColor = (areaName, defaultColor = "#858585") => {
    return areaColors[areaName] || defaultColor;
  };
    ...
    >
      ...
      <Rect
        ...
        style={{
          ...
          strokeMiterlimit: 4,
          fill: getFillColor("patio", "#36ac36"),
          fillRule: "nonzero",
          opacity: 1,
        }}
      ...
      <Rect
        ...
        style={{
          ...
          strokeLinejoin: "miter",
          strokeMiterlimit: 4,
          fill: getFillColor("sala medica", "#858585"),
          fillRule: "nonzero",
          opacity: 1,
        }}
      ...
      <Rect
        ...
        style={{
          ...
          strokeLinejoin: "miter",
          strokeMiterlimit: 4,
          fill: getFillColor("comedor", "#858585"),
          fillRule: "nonzero",
          opacity: 1,
        }}
      ...
      <Rect
        ...
        style={{
          ...
          strokeLinejoin: "miter",
          strokeMiterlimit: 4,
          fill: getFillColor("dormitorio", "#858585"),
          fillRule: "nonzero",
          opacity: 1,
        }}
