...
const FamilyNavigator = ({ onLogout, userRole, currentUserId, loggedInResidentId }) => { 
  ...
  return (
    <Drawer.Navigator
      initialRouteName="FamilyResidentProfile" // Ya configurado como la pantalla inicial
    ...
    >
      <Drawer.Screen
        ...
        options={{ title: 'Home' }} // CAMBIADO: Ahora el título en el menú lateral será "Home"
      >
        {(props) => (
      ...
      />
      <Drawer.Screen name="FamilyChat" options={{ title: 'CHAT FAMILIAR' }}>
        {(props) => (
          <FamilyChatScreen
            {...props}
            currentUserRole={userRole}
